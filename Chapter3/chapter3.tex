...
\noindent In this instance, the maximum sweep voltage has been configured to 3V with a 3 mA current compliance, a setting sufficient for switching to occur. It has been demonstrated that a reduction in voltage below the threshold does not result in the device transitioning to its previous state \cite{mehonic2016silicon}.\\
